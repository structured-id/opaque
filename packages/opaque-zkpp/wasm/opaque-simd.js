/* @ts-self-types="./opaque-simd.d.ts" */
 ...
 * @returns {string}
 */
export function generate_zkpp_proof_bound(password, policy_version, blind, context) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(blind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(context, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.generate_zkpp_proof_bound(ptr0, len0, policy_version, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {string}
 */
export function get_policy(version) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_policy(version);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @param {number} policy_version
 */
export function init_zkpp_keys(params, pk, policy_version) {
    const ptr0 = passArray8ToWasm0(params, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(pk, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.init_zkpp_keys(ptr0, len0, ptr1, len1, policy_version);
    if (ret[1]) {
 ...
 * @returns {string}
 */
export function prepare_breach_check(password) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.prepare_breach_check(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function validate_password(password, policy_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.validate_password(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @param {string} password
 * @param {string} hibp_response
 * @returns {string}
 */
export function verify_breach_response(password, hibp_response) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(hibp_response, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.verify_breach_response(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('opaque-simd_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
